...
class StratifiedModel(BaseModel):
    ...
    def _fit(
        ...
        Args:
            ...
            ai_function: Function to use in robust variance calculations later in estimation step.
        ...
        one_nonzero_strata: list[Any] = []  # ratiomodel
    ...
    def get_estimates(
        ...
        if is_aggregate:
            ...
            strata_df = self._add_variance(
                strata_df, domain, variance_type, self.ai_function
            )
